...
export function AppSidebar() {
      ...
      <SidebarHeader className="border-b border-sidebar-border px-6 py-4 bg-background">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground">
            <Atom className="h-4 w-4 animate-spin-slow text-red-600" />
          </div>
          <div>
  ...
  <DialogContent className="max-w-md animate-in fade-in zoom-in-75 bg-gradient-to-br from-white to-muted p-6 rounded-xl shadow-xl border">
    ...
    <div className="flex flex-col items-center mt-2">
      ...
      <h3 className="text-lg font-semibold">Alfi Maulana Alfarisi</h3>
    ...
    <div className="flex justify-end gap-2 mt-4">
      <Button variant="outline" className="hover:shadow-md transition">
        Edit Profile
      </Button>
      <Link href="/auth/login">
        <Button variant="destructive" className="hover:scale-105 transition">
          Logout
        </Button>
      </Link>
    </div>
