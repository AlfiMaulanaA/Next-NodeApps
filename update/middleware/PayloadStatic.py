...
def load_mqtt_config():
    try:
        ...
        broker_host = config.get("broker_address", "18.143.215.113")
        ...
        logger.info("Using default MQTT configuration (18.143.215.113:1883, no auth)")
        return {"broker": "18.143.215.113", "port": 1883, "username": "", "password": ""}
...
# CRUD Client for 18.143.215.113 broker
