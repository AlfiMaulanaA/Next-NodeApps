...
def load_device_library(library_type="modbus"):
    ...
    try:
        ...
        send_error_log("load_device_library", error_msg, "error", {"file_path": library_path, "library_type": library_type})
        return {}
...
def handle_device_selection_message(client, userdata, message):
    ...
    try:
        ...
        log_simple(error_msg, "ERROR")
        send_error_log("handle_device_selection_message", error_msg, "error", {"command": command})
...
def handle_i2c_device_selection_message(client, userdata, message):
    ...
    try:
        ...
        log_simple(error_msg, "ERROR")
        send_error_log("handle_i2c_device_selection_message", error_msg, "error", {"command": command})
...
def send_modular_available_devices(client):
    ...
    try:
        ...
        log_simple(error_msg, "ERROR")
        send_error_log("send_modular_available_devices", error_msg, "error")
...
def send_modbus_available_devices(client):
    ...
    try:
        ...
        log_simple(error_msg, "ERROR")
        send_error_log("send_modbus_available_devices", error_msg, "error")
...
def periodic_available_devices_publish(client):
    ...
    while True:
        try:
            ...
            log_simple(error_msg, "ERROR")
            send_error_log("periodic_available_devices_publish", error_msg, "error")
...
def handle_available_devices_command(client, userdata, message):
    ...
    try:
        ...
        log_simple(error_msg, "ERROR")
        send_error_log("handle_available_devices_command", error_msg, "error", {"command": command})
