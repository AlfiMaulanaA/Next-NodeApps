...
const RegisterPage = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        // Auto-login setelah register berhasil (dijalankan di AuthContext)
        // Router push akan dihandle oleh useEffect di AuthContext
      } else {
  ...
  // Image carousel for device display
  const images = [
  ...
  const checkPasswordStrength = (pwd: string) => {
    ...
    if (score <= 2) {
      ...
      setPasswordStrengthColor("text-destructive");
    } else if (score === 3 || score === 4) {
      setPasswordStrength("Medium");
      setPasswordStrengthColor("text-yellow-600");
    } else if (score === 5) {
      setPasswordStrength("Strong");
      setPasswordStrengthColor("text-green-600");
    } else {
      setPasswordStrength("");
      setPasswordStrengthColor("text-muted-foreground");
    }
    return score;
  };
  ...
  return (
    <div className="flex min-h-screen font-sans bg-gradient-to-br from-background via-background/95 to-background/90 relative">
      ...
      {/* Kanan: Form Register - Full dark mode support */}
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground text-base">
              <span className="relative">
                Sign up to access the IoT Gateway Dashboard
                <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-primary/50 animate-[width_2s_ease-out_0.5s]" style={{ width: "0%" }} />
              </span>
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            {password && (
              <>
                ...
                <div className="w-full h-2 mt-1 rounded bg-muted overflow-hidden">
                  <div
