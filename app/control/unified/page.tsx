...
interface UnifiedTriggerCondition {
  device_name: string;
  device_topic?: string;
  trigger_type: "drycontact" | "numeric";
...
const UnifiedAutomationControl = () => {
  ...
  // Available condition operators for different trigger types
  ...
  const loadModbusDevices = useCallback(() => {
    publishMQTT("command_available_device", "get_modbus_devices");
  }, [publishMQTT]);
    ...
    if (typeof window !== "undefined") {
      try {
        ...
        currentClient.on("connect", () => {
          ...
          console.log("Subscribed to unified automation topics");
  ...
  }, [TOPICS, refreshData, loadModbusDevices, loadModularDevices]);
  ...
  const confirmDelete = (rule: UnifiedAutomationRule) => {
    setConfirmationDialogContent({
      ...
      confirmAction: () => deleteRule(rule.id),
    });
    ...
    <SidebarInset>
      ...
      <header className="flex h-16 items-center justify-between border-b px-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Unified Automation Control</h1>
        </div>
        <div className="flex items-center gap-2">
          <MqttStatus />
          <Button
                          ...
                          >
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                  ...
                                  <Select
                                    ...
                                    onValueChange={(value) => {
                                      updateTrigger(groupIndex, triggerIndex, {
                                        ...trigger,
                                        trigger_type: value as "drycontact" | "numeric",
                                        device_name: "", // Reset device when changing type
                                        field_name: value === "numeric" ? "" : trigger.field_name,
                                        pin_number: value === "drycontact" ? 1 : trigger.pin_number,
                                        condition_operator: value === "drycontact" ? "is" : "greater_than",
                                        target_value: value === "drycontact" ? true : 0,
                                      });
                                    }}
                                  >
                                    <SelectTrigger>
                                ...
                                {/* Device Selection - filtered by type */}
                                <div>
